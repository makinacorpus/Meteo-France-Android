...
public class MyPagerAdapterTime extends PagerAdapter {
	...
	public Object instantiateItem(ViewGroup container, int position) {
		...
		switch (position) {
		case 1:
			view.setText(mContext.getResources().getString(R.string.apresmidi),
					mContext.getResources().getString(R.string.apresmidi_time));

			view.setSelected();
			break;
		case 2:
			view.setText(mContext.getResources().getString(R.string.soir),
					mContext.getResources().getString(R.string.soir_time));

			break;
		default:
			view.setText(mContext.getResources().getString(R.string.matinee),
					mContext.getResources().getString(R.string.matinee_time));
